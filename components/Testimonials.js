    ...
    <section id="depoimentos" className="py-20 md:py-28 bg-[#0d1526] relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          {/* Google Rating Badge */}
          <div className="inline-flex flex-col sm:flex-row items-center gap-3 sm:gap-4 bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl px-5 sm:px-6 py-4 mb-8">
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                <span className="font-mono text-2xl sm:text-3xl font-bold text-white">{googleReviews.rating}</span>
                <StarRating rating={5} />
              </div>
            </div>
            <div className="hidden sm:block w-px h-8 bg-white/20" />
            <span className="text-[#9dd1f1]/80 text-sm sm:text-base">{googleReviews.totalReviews} avaliações</span>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          {testimonials.map((testimonial, index) => (
            ...
            >
              ...
              {/* Card */}
              <div className="relative bg-gradient-to-br from-[#1a2744] to-[#131d35] rounded-2xl p-5 sm:p-8 border border-[#243556] hover:border-[#6bb8e8]/30 transition-all duration-500">
                {/* Quote icon */}
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
                  <div className="flex items-center gap-3 sm:gap-4">
                    {/* Avatar */}
                    <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-gradient-to-br from-[#6bb8e8]/20 to-[#6bb8e8]/5 border border-[#6bb8e8]/20 flex items-center justify-center flex-shrink-0">
                      <span className="text-[#6bb8e8] font-bold text-lg sm:text-xl">
                ...
                {/* Comment */}
                <p className="text-[#9dd1f1]/80 text-base sm:text-lg leading-relaxed mb-4">
