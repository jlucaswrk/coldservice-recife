            ...
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-br from-[#0a0f1a] to-[#131d35] rounded-2xl border border-[#243556] overflow-hidden">
                ...
                <div className="relative p-4">
                  ...
                  {/* Location Status + CTA */}
                  <div className="mt-3">
                    {(locationStatus === "ip-found" || locationStatus === "precise-found" || locationStatus === "asking-permission") && neighborhood && (
                      <a
                        href={buildWhatsAppUrl(siteConfig.whatsapp, `Olá! Estou em ${neighborhood} e preciso de um técnico para minha geladeira.`)}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="group block w-full bg-gradient-to-r from-[#25d366] to-[#1da851] hover:from-[#1da851] hover:to-[#169c46] rounded-xl p-3 transition-all duration-300 hover:scale-[1.02] hover:shadow-xl hover:shadow-[#25d366]/20"
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <p className="text-white font-bold text-sm">Chamar técnico para {neighborhood}</p>
                              <p className="text-white/70 text-xs">Atendimento em até 2 horas</p>
                            </div>
                          </div>
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <p className="text-white font-bold text-sm">Chamar técnico agora</p>
                              <p className="text-white/70 text-xs">Atendemos toda Recife e região</p>
                            </div>
                          </div>
                          <svg className="w-5 h-5 text-white/80 group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
