          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                ...
                className="inline-flex items-center justify-center gap-3 bg-gradient-to-r from-[#ff6b35] to-[#e55a2b] text-white px-8 py-4 rounded-xl font-bold transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-[#ff6b35]/30"
              >
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-3 bg-[#25d366] hover:bg-[#1da851] text-white px-8 py-4 rounded-xl font-bold transition-all duration-300 hover:scale-105"
              >
